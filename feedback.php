...
$headers = 'From: "Therapy Exam Prep" <noreply@therapyexamprep.com>' . "\r\n" .
    'X-Mailer: PHP/' . phpversion();
	
$message = 'Question ID: '.$_REQUEST['qid']."\r\n".'Username: '.$_REQUEST['user']."\r\n".'Comment: '.$comment;

$result = array('result' => 'failed');
if(mail('alberto@therapyexamprep.com', 'Practice Exam Feedback', $message, $headers)) $result['result'] = 'success';
