...
$(document).ready(function()
{
    ...
    window.resizeTo(window.innerWidth, 920);                     
});
</script>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:95%;    border-radius:0px;  text-align:left;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span id="questionDisplay">Page 1 of 8</span>
</div>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:100%;    border-radius:0px;  text-align:right;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span>Time Remaining: </span><span id="TimerDisplay">00:15:00</span>
</div>
...
<p>Welcome to the practice exam tutorial.</p>
<p>This tutorial will give you an overview of the practice exam simulation environment and explain how to use certain features. Please take the time to familiarize yourself with their operation before beginning the timed exam.</p>
<p>You have 15 minutes to complete this tutorial before the exam begins. The timer at the top of the screen counts down the time remaining.</p>
...
<input class="nolabel btn  " type="button" name="Next" id="Next"  value="Next" onClick=TEP_EXAM.controller.nextButtonClicked('page1.php');   />
</div>
<!-- Form Field End -->
