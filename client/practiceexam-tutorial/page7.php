...
// Build 689
loadPersistantValues(0, $job_id, "page7.php");

// Build 805
if(1 == 0){
    init_stats($job_id, "page7.php", 'form');
}
...
<a id="top"></a>
<!-- OUTPUT_START -->
<div id="rackforms-output-div-page7" class="rackforms-output-div col-lg-9 ui form" style=" font-family: DejaVu Sans, Arial, Helvetica, sans-serif;       width:94%;   ">
<form class="rackforms-output-sortable" action="<?php echo $_SESSION['MAX_PATH']; ?>page7_process.php<?php echo $sid_url; ?>" method="post" enctype="application/x-www-form-urlencoded" name="page7php" id="page7" target="_self" >
<?php
$visible = '';
$enabled = '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-TopHeader7" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="TopHeader7" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Bucket Item - Responsive Form Field Start -->
<div id="fb_fld-Logo_1_2_3_4_5_6_7_7" rf-field="true" class="" style="<?php echo $visible; ?> float:left; width:33%; z-index:1; margin-bottom:15px">
...
<!-- Form Field Start -->
<div id="fb_fld-HeaderView7" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="HeaderView7" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:95%;    border-radius:0px;  text-align:left;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span id="questionDisplay">Page 8 of 8</span>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-SummaryView7" rf-field="true" class="" style="float:left; width:; margin-bottom:9px; <?php echo $visible; ?>" >
...
<!-- Form Field Start -->
<div id="fb_fld-QuestionView7" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="QuestionView7" class="bucket" style="position:relative; height:127px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<p>The exam timer at the top of the screen will reset once the exam begins and count down the remaining exam time. Once the exam timer expires, the exam will automatically end.</p>
<p>This concludes the tutorial.</p>
<p>Note: Some images shown in exam questions are licensed or used with permission. All images are copyright to their respective owners and protected under international copyright laws. No parts of the exam content or images may be reproduced or distributed.
</p>
<p>Click 'Next' to begin your exam...</p>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-NavQuestion7" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="NavQuestion7" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<input class="nolabel btn  " type="button" name="Previous" id="Previous"  value="Previous" onClick=TEP_EXAM.controller.prevButtonClicked('page6.php');   />
</div>
<!-- Form Field End -->
...
<input class="nolabel btn  fld-full" type="button" name="Next" id="Next"  value="Next" onClick=TEP_EXAM.controller.nextButtonClicked('https://therapyexamprep.com/products/practice-exam/client/practiceexam/page0.php');   />
</div>
<!-- Form Field End -->
