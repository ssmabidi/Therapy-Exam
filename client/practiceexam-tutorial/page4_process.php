...
savePersistantValues(0, $db_key, 0, 'page5.php');
...
if($error){
	...
	if(isset($_SESSION['pages']['page5.php'])) { 
		unset($_SESSION['pages']['page5.php']);
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page4.php']);
	} 
	...
	$_SESSION['pages']['page5.php'] = 'pass';
	
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page4.php'] = 'pass';
