...
savePersistantValues(0, $db_key, 0, 'page2.php');
...
if($error){
	...
	if(isset($_SESSION['pages']['page2.php'])) { 
		unset($_SESSION['pages']['page2.php']);
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['error.php']);
	} 
	
	$_SESSION["e_message"] = $valError;
	header("Location: {$_SESSION['MAX_PATH_PROC']}error.php{$sid_url}");
	return;
} else {
	$_SESSION['pages']['page2.php'] = 'pass';
	
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['error.php'] = 'pass';
	...
	// default action
	header("Location: {$_SESSION['MAX_PATH_PROC']}page2.php{$sid_url}");
	return;
}
