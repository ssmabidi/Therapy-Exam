...
// Build 689
loadPersistantValues(0, $job_id, "error.php");

// Build 805
if(1 == 0){
    init_stats($job_id, "error.php", 'form');
}
...
<a id="top"></a>
<!-- OUTPUT_START -->
<div id="rackforms-output-div-error" class="rackforms-output-div col-lg-9 ui form" style=" font-family: DejaVu Sans, Arial, Helvetica, sans-serif;       width:94%;   ">
<form class="rackforms-output-sortable" action="<?php echo $_SESSION['MAX_PATH']; ?>error_process.php<?php echo $sid_url; ?>" method="post" enctype="application/x-www-form-urlencoded" name="errorphp" id="error" target="_self" >
<?php
$visible = '';
$enabled = '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-TopHeaderError" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="TopHeaderError" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-SummaryView_1" rf-field="true" class="" style="float:left; width:; margin-bottom:9px; <?php echo $visible; ?>" >
...
<!-- Form Field Start -->
<div id="fb_fld-ErrorView_1" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="ErrorView_1" class="bucket" style="position:relative; height:156px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Bucket Item - Responsive Form Field Start -->
<div id="fb_fld-questionText" rf-field="true" class="ErrorMessage" style="<?php echo $visible; ?> float:left; width:100%; z-index:1; margin-bottom:15px">
