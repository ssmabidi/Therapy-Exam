...
if($error){
	...
	if(isset($_SESSION['pages']['page1.php'])) { 
		...
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page0.php']);
	} 
	...
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page0.php'] = 'pass';
