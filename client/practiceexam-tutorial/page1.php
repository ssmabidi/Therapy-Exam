...
// Build 689
loadPersistantValues(0, $job_id, "page1.php");

// Build 805
if(1 == 0){
    init_stats($job_id, "page1.php", 'form');
}
...
<a id="top"></a>
<!-- OUTPUT_START -->
<div id="rackforms-output-div-page1" class="rackforms-output-div col-lg-9 ui form" style=" font-family: DejaVu Sans, Arial, Helvetica, sans-serif;       width:94%;   ">
<form class="rackforms-output-sortable" action="<?php echo $_SESSION['MAX_PATH']; ?>page1_process.php<?php echo $sid_url; ?>" method="post" enctype="application/x-www-form-urlencoded" name="page1php" id="page1" target="_self" >
<?php
$visible = '';
$enabled = '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-TopHeader1" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="TopHeader1" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Bucket Item - Responsive Form Field Start -->
<div id="fb_fld-Logo_1" rf-field="true" class="" style="<?php echo $visible; ?> float:left; width:33%; z-index:1; margin-bottom:15px">
...
<!-- Form Field Start -->
<div id="fb_fld-HeaderView1" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="HeaderView1" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:95%;    border-radius:0px;  text-align:left;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span id="questionDisplay">Page 2 of 8</span>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-SummaryView1" rf-field="true" class="" style="float:left; width:; margin-bottom:9px; <?php echo $visible; ?>" >
...
<!-- Form Field Start -->
<div id="fb_fld-QuestionView1" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="QuestionView1" class="bucket" style="position:relative; height:127px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<p>During the exam you will be able to navigate forward and backward using the 'Next' and 'Previous' buttons at the bottom of the screen. The top of the screen will indicate the question number and current section. You may only navigate between questions within the current section.<p>
...
<!-- Form Field Start -->
<div id="fb_fld-NavQuestion1" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="NavQuestion1" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<input class="nolabel btn  " type="button" name="Previous" id="Previous"  value="Previous" onClick=TEP_EXAM.controller.prevButtonClicked('page0.php');   />
</div>
<!-- Form Field End -->
...
<input class="nolabel btn  " type="button" name="Next" id="Next"  value="Next" onClick=TEP_EXAM.controller.nextButtonClicked('page2.php');   />
</div>
<!-- Form Field End -->
