...
// Build 689
loadPersistantValues(0, $job_id, "page4.php");

// Build 805
if(1 == 0){
    init_stats($job_id, "page4.php", 'form');
}
...
<a id="top"></a>
<!-- OUTPUT_START -->
<div id="rackforms-output-div-page4" class="rackforms-output-div col-lg-9 ui form" style=" font-family: DejaVu Sans, Arial, Helvetica, sans-serif;       width:94%;   ">
<form class="rackforms-output-sortable" action="<?php echo $_SESSION['MAX_PATH']; ?>page4_process.php<?php echo $sid_url; ?>" method="post" enctype="application/x-www-form-urlencoded" name="page4php" id="page4" target="_self" >
<?php
$visible = '';
$enabled = '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-TopHeader4" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="TopHeader4" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Bucket Item - Responsive Form Field Start -->
<div id="fb_fld-Logo_1_2_3_4" rf-field="true" class="" style="<?php echo $visible; ?> float:left; width:33%; z-index:1; margin-bottom:15px">
...
<!-- Form Field Start -->
<div id="fb_fld-HeaderView4" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="HeaderView4" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:95%;    border-radius:0px;  text-align:left;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span id="questionDisplay">Page 5 of 8</span>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-SummaryView4" rf-field="true" class="" style="float:left; width:; margin-bottom:9px; <?php echo $visible; ?>" >
...
<!-- Form Field Start -->
<div id="fb_fld-QuestionView4" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="QuestionView4" class="bucket" style="position:relative; height:127px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<p>The highlight feature lets you mark any region of text in a question for future reference. The highlight will persist as you proceed through an exam section. Click and drag over any part of the question to select a region of text and it will become highlighted. To clear the highlight, click over the highlighted region and it will be cleared.</p>
<p>Note: Highlights cannot be applied to answer choices.</p>
<p>Try this now, select any region of text to highlight it. Next, click the highlighted region to clear the highlight.</p>
...
<!-- Form Field Start -->
<div id="fb_fld-NavQuestion4" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="NavQuestion4" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<input class="nolabel btn  " type="button" name="Previous" id="Previous"  value="Previous" onClick=TEP_EXAM.controller.prevButtonClicked('page3.php');   />
</div>
<!-- Form Field End -->
...
<input class="nolabel btn  " type="button" name="Next" id="Next"  value="Next" onClick=TEP_EXAM.controller.nextButtonClicked('page5.php');   />
</div>
<!-- Form Field End -->
