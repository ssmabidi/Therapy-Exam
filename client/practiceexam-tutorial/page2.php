...
// Build 689
loadPersistantValues(0, $job_id, "page2.php");

// Build 805
if(1 == 0){
    init_stats($job_id, "page2.php", 'form');
}
...
<a id="top"></a>
<!-- OUTPUT_START -->
<div id="rackforms-output-div-page2" class="rackforms-output-div col-lg-9 ui form" style=" font-family: DejaVu Sans, Arial, Helvetica, sans-serif;       width:94%;   ">
<form class="rackforms-output-sortable" action="<?php echo $_SESSION['MAX_PATH']; ?>page2_process.php<?php echo $sid_url; ?>" method="post" enctype="application/x-www-form-urlencoded" name="page2php" id="page2" target="_self" >
<?php
$visible = '';
$enabled = '';
?>
...
<!-- Form Field Start -->
<div id="fb_fld-TopHeader2" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="TopHeader2" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<!-- Bucket Item - Responsive Form Field Start -->
<div id="fb_fld-Logo_1_2" rf-field="true" class="" style="<?php echo $visible; ?> float:left; width:33%; z-index:1; margin-bottom:15px">
...
<!-- Form Field Start -->
<div id="fb_fld-HeaderView2" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="HeaderView2" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<div class="section-head " style="color:#d3d3d3; font-size:16px; font-weight:normal; width:95%;    border-radius:0px;  text-align:left;   padding-left:0px;  padding-right:0px;  padding-top:0px;  padding-bottom:0px;  ">
<span id="questionDisplay">Page 3 of 8</span>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-SummaryView2" rf-field="true" class="" style="float:left; width:; margin-bottom:9px; <?php echo $visible; ?>" >
...
<!-- Form Field Start -->
<div id="fb_fld-QuestionView2" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="QuestionView2" class="bucket" style="position:relative; height:127px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<p>Each question will present you with 4 answers to choose from. Click on the circle to the left of the numbered choice to make your selection. You may change your selection by clicking a different circle next to the desired numbered choice.<p>
<p>Go ahead and try this now. Click on any one of the circles next to the numbered choices below then click 'Next' to continue.</p>
</div>
...
<!-- Form Field Start -->
<div id="fb_fld-NavQuestion2" rf-field="true" class="" style="float:left; width:100%; margin-bottom:9px; <?php echo $visible; ?>" >


<!-- bucket start -->
<div id="NavQuestion2" class="bucket" style="position:relative; height:69px; width:; " >
<?php
$visible = '';
$enabled= '';
?>
...
<input class="nolabel btn  " type="button" name="Previous" id="Previous"  value="Previous" onClick=TEP_EXAM.controller.prevButtonClicked('page1.php');   />
</div>
<!-- Form Field End -->
...
<input class="nolabel btn  " type="button" name="Next" id="Next"  value="Next" onClick=TEP_EXAM.controller.nextButtonClicked('page3.php');   />
</div>
<!-- Form Field End -->
