...
savePersistantValues(0, $db_key, 0, 'page8.php');
...
if($error){
	...
	if(isset($_SESSION['pages']['page8.php'])) { 
		unset($_SESSION['pages']['page8.php']);
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page7.php']);
	} 
	
	$_SESSION["e_message"] = $valError;
	header("Location: {$_SESSION['MAX_PATH_PROC']}page7.php{$sid_url}");
	return;
} else {
	$_SESSION['pages']['page8.php'] = 'pass';
	
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page7.php'] = 'pass';
	...
	// default action
	header("Location: {$_SESSION['MAX_PATH_PROC']}page8.php{$sid_url}");
	return;
}
