...
if($error){
	...
	if(isset($_SESSION['pages']['page2.php'])) { 
		...
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page1.php']);
	} 
	...
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page1.php'] = 'pass';
