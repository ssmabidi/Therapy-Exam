...
savePersistantValues(0, $db_key, 0, 'page7.php');
...
if($error){
	...
	if(isset($_SESSION['pages']['page7.php'])) { 
		unset($_SESSION['pages']['page7.php']);
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page6.php']);
	} 
	...
	$_SESSION['pages']['page7.php'] = 'pass';
	
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page6.php'] = 'pass';
