...
savePersistantValues(0, $db_key, 0, 'page3.php');
...
if($error){
	...
	if(isset($_SESSION['pages']['page3.php'])) { 
		unset($_SESSION['pages']['page3.php']);
		unset($_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page2.php']);
	} 
	...
	$_SESSION['pages']['page3.php'] = 'pass';
	
	$_SESSION['pages-passed']["{$_SESSION['entry_key_practiceexam-tutorial']}"]['page2.php'] = 'pass';
