	...
	switch($action){
		...
		default :
			...
			if($fb_img_size == 'normal'){
				...
				if(isset($_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_table_name']) && $_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_table_name'] != ""){
					
					$table = $_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_table_name'];
					$column = $_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_name'];
					$columnid = $_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_id'];
					$database_image_id = $_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_database_image_id'];
					...
					// Clear SESSION Items.
					$_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_table_name'] = "";
					unset($_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_table_name']);
					
					$_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_name'] = "";
					unset($_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_name']);
					
					$_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_id'] = "";
					unset($_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_column_id']);
					
					$_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_database_image_id'] = "";
					unset($_SESSION["{$_SESSION['entry_key_practiceexam']}"]["{$rand}"]['imagecall_database_image_id']);
